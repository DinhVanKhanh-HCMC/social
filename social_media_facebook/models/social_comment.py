    ...
    def action_reply(self, message=None):
        ...
        for account in self.post_id.account_ids:
            if account.media_type == "facebook" and hasattr(
                ...
                result = account._reply_to_facebook_comment(
                    self.comment_id, message
                )
            ...
            if account.media_type == "facebook" and hasattr(
                ...
                if isinstance(result, dict):
                    if result.get("success"):
                        ...
                        error_msg = result.get("message", "Failed to hide comment on Facebook")
