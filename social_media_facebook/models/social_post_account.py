...
class SocialPostAccount(models.Model):
    ...
    fb_video_url = fields.Char(string="Facebook Video URL", help="Direct URL to the Facebook video file (for reels/videos)")
    ...
    def _sync_published_post_from_facebook(self, fb_post_id):
        ...
        This allows the Facebook Analytics tab to appear and show metrics for Odoo-created posts.
        ...
        try:
            ...
            if isinstance(response, dict) and response.get("id"):
                ...
                comments_count = (
                    response.get("comments", {}).get("summary", {}).get("total_count", 0)
                )
        ...
        try:
            ...
            for comment in comments:
                comment_data = {
                    ...
                    "created_time": comment.created_time.isoformat() if comment.created_time else False,
                ...
                for reply in comment.reply_ids:
                    reply_data = {
                        ...
                        "created_time": reply.created_time.isoformat() if reply.created_time else False,
    ...
    def create_comment(self, post_data, context=None):
        ...
        Args:
            post_data: dict with keys:
                - "comment_id": ID of the comment to reply to (optional, if replying to a comment)
        ...
        try:
            ...
            if parent_comment_id:
                response = account._reply_to_facebook_comment(parent_comment_id, message)
